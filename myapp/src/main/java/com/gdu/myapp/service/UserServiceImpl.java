...
public class UserServiceImpl implements UserService {
  ...
  public void signin(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      String pw = MySecurityUtils.getSha256(request.getParameter("pw")); // 암호화
      ...
      if(user != null) {
        ...
        userMapper.insertAccessHistory(params); // user != null 성공 했을 때 기록 남기기
      ...
      // 일치하는 회원 없음 (Sign In 실패)  
        ...
        out.println("location.href='" + request.getContextPath() + "/main.page'"); // 위에 alert 경고창 멘트 나오고 보낼 주소
        out.println("</secript>");
        out.flush();
        out.close();
      }
