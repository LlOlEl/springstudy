...
<body>
    ...
    <%-- MyController2 --%>
    <div>
      <a href="${contextPath}/board/list.do">board 목록</a> <!-- MyController2 의 value 주소와 연계 -->
    </div>
    
    <%-- MyController3 --%>
    <div>
      <a href="${contextPath}/article/detail1.do?article_no=10">article 상세1</a> <!-- MyController2 의 value 주소와 연계 -->
      <a href="${contextPath}/article/detail2.do">article 상세2</a> <!-- MyController2 의 value 주소와 연계 -->
      <a href="${contextPath}/article/detail3.do?article_no=10">article 상세3</a> <!-- MyController2 의 value 주소와 연계 -->
    </div>
